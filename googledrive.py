...
def main():
    ...
    # time.
    if os.path.exists('./credentials/user_token.json'):
        creds = Credentials.from_authorized_user_file('./credentials/user_token.json', SCOPES)
    ...
    if not creds or not creds.valid:
        if creds and creds.expired and creds.refresh_token:
            ...
            flow = InstalledAppFlow.from_client_secrets_file(
                './credentials/oauth_secret.json', SCOPES)
        ...
        with open('./credentials/user_token.json', 'w') as token:
